...
threshold_ph = (reference_values['Reference Range'][0][1] - reference_values['Reference Range'][0][0]) / 2

# Prüfen für Pelger_Huet_Anomalie
if abs(diff_ph[0]) > threshold_ph:
...
threshold_eo = (reference_values['Reference Range'][0][1] - reference_values['Reference Range'][0][0]) / 2

# Prüfen für Eosinophilie
if abs(diff_eo[0]) > threshold_eo:
